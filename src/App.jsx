import { useState, useRef, useEffect } from 'react'; // Force refresh
import { Routes, Route, Link, useNavigate, useLocation } from 'react-router-dom';
import { HelmetProvider } from 'react-helmet-async';
import { Star, Settings as SettingsIcon, LogOut, User, Activity } from 'lucide-react';
...
function App() {
  ...
  // Global Title Reset on Route Change
  useEffect(() => {
    document.title = 'CineRank';
  }, [location.pathname]);
          ...
          {isAdmin ? (
            ...
            <div className={`min-h-screen p-6 md:p-12 md:pt-32 max-w-[2000px] mx-auto pb-24 md:pb-12 ${viewAsSignedOut ? 'pt-16' : ''}`}>
              ...
              <Routes>
                ...
                <Route path="/person/:id/:slug?" element={<ActorDetails />} />
